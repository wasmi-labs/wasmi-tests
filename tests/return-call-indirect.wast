...
(module
    ...
    (func $tail (export "identity-0") (type $ty)
        (return_call_indirect $t (type $ty)
            (i32.const 0) ;; index
        )
    )
    (func (export "nested-identity-0") (type $ty)
        (call $tail)
    )
)
...
(module
    ...
    (func $tail (export "identity-1") (type $ty)
        (return_call_indirect $t (type $ty)
            (local.get 0)
            (i32.const 0) ;; index
        )
    )
    (func (export "nested-identity-1") (type $ty)
        (call $tail
            (local.get 0)
        )
    )
...
(module
    ...
    (func $tail (export "identity-2") (type $ty)
        (return_call_indirect $t (type $ty)
            (local.get 0)
            (local.get 1)
            (i32.const 0) ;; index
    ...
    (func (export "nested-identity-2") (type $ty)
        (call $tail
            (local.get 0)
            (local.get 1)
        )
...
(module
    ...
    (func $tail (export "offset-1") (type $ty)
        (return_call_indirect $t (type $ty)
            (local.get 0)
            (i32.const 0) ;; index
        )
    )
    (func (export "nested-offset-1") (type $ty)
        (call $tail
            (local.get 0)
        )
    )
...
(module
    ...
    (func $tail (export "offset-2") (type $ty)
        (return_call_indirect $t (type $ty)
            (local.get 0)
            (local.get 1)
            (i32.const 0) ;; index
    ...
    (func (export "nested-offset-2") (type $ty)
        (call $tail
            (local.get 0)
            (local.get 1)
        )
...
(module
    ...
    (func $tail (export "sum-3") (type $ty)
        (return_call_indirect $t (type $ty)
            (local.get 0)
            (local.get 1)
            (local.get 2)
    ...
    (func (export "nested-sum-3") (type $ty)
        (call $tail
            (local.get 0)
            (local.get 1)
            (local.get 2)
...
(module
    ...
    (func $tail (export "iota-3") (type $ty)
        (return_call_indirect $t (type $ty)
            (local.get 0)
            (i32.const 0) ;; index
        )
    )
    (func (export "nested-iota-3") (type $ty)
